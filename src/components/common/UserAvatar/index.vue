...
<template>
	<div class="flex items-center overflow-hidden">
		<div class="mt-5 w-10 h-15 overflow-hidden rounded-full shrink-0">
        ...
        <span
			...
			>
        <span v-if="!!authStore.session?.auth && !authStore.token" class="text-sm text-[#ff69b4] dark:text-white">
